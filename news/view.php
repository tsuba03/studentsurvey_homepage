...
$id = basename($_GET['id']); // セキュリティ対策
$file = __DIR__ . "/posts/$id";
...
<use xlink:href="/studentsurvey/assets/img/sprite.svg#arrow_up"></use>
</svg>
</a>
<script src="/studentsurvey/assets/js/main.js"></script>
</body>
</html>
